/* Slightly modified crc-32 algorithm from https://create.stephan-brumme.com/crc32/ */
...
{
	const size_t prefetch_ahead = 256;
	...
	while (length >= bytes_at_once + prefetch_ahead) {
		PREFETCH(((const char *) current) + prefetch_ahead);
